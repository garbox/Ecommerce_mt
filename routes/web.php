...
Route::get('dashboard/products/edit/{id}', [DashboardController::class , 'editProducts'])->name('product edit')->middleware(Admin::class);
Route::post('dashboard/products/delete', [DashboardController::class , 'deleteProducts'])->middleware(Admin::class);

Route::get('dashboard/createproduct', [DashboardController::class , 'createProduct'])->name('create product')->middleware(Admin::class);
Route::post('dashboard/createproduct', [DashboardController::class , 'insertProduct'])->middleware(Admin::class);

// Dashbaord create type 
Route::get('dashboard/createtype', [DashboardController::class , 'showType'])->name('create type')->middleware(Admin::class);
...
Route::get('dashboard/createattributes', [AttributeController::class , 'createAttributes'])->name('create attributes')->middleware(Admin::class);
